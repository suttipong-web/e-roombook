...
CREATE TABLE `room_schedules` (
  ...
  `booking_time_start` varchar(255) NOT NULL,
  `booking_time_finish` varchar(255) DEFAULT NULL,
  ...
  `goup_year` varchar(10) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`,`onDays`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of room_schedules
-- ----------------------------
INSERT INTO `room_schedules` VALUES ('1', '12312', 'grgr', '1', '100', 'จันทร์', '0800', '0830', null, '8', 'TESC', '123123', '0', '0', null, null, null, null, null, '2024-07-02 09:36:12', '2024-07-02 09:36:12');
INSERT INTO `room_schedules` VALUES ('2', '12312', 'COMAWE', '2', '0', 'จันทร์', '0900', '0930', null, '8', 'TESC2', '213', '0', '0', null, null, null, 'suttipong.r@cmu.ac.th', null, '2024-07-02 09:57:52', '2024-07-02 09:57:52');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', null, 'suttipong.r@cmu.ac.th', null, 'b986700c627db479a4d9460b75de7222', '1', '1', null, null, '2024-07-02 09:51:30', 'suttipong.r', 'นาย', 'สุทธิพงค์', 'ริโปนยอง', 'MISEmpAcc', 'บุคลากร', null, null, '2024-07-02 09:51:30', '0');
