                                ...
                                @foreach ($getBookingList as $rows)
                                    <tr style="text-align: left;">
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-primary btn-sm editIcon"
                                                bookingID="{{ $rows->id }}">
    ...
    <div class="modal fade" id="modalbookingDetail" tabindex="-1" aria-labelledby="bookingDetail" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body p-2 viewBooking">
                    <form id="approve_booking_form" class="row g-3 m-auto" method="post" action="#"
                        ...
                        <div class="col-md-12 p-2">
                            ...
                            @if ($getStatus == 'Newinbox')
                                <div class="col-md-12">
                                    <div
                                        class="text-center justify-content-center w-50 p-3 border border-danger bg-light bg-opacity-10 m-auto fw-bold">
