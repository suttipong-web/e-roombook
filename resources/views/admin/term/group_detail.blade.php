    ...
    <div class="row">
        <div class="container-fluid">
            <div class="d-sm-flex align-items-end justify-content-start mb-4">
                <h4> <a href="/admin/groupCourse">จัดการผู้ลงตารางใช้ห้อง </a>
                ...
                <div class="card-body  disPlayTable">
                    ...
                    <div class="mb-2">
                        <div class="row text-center justify-content-center">
                            ...
                            <table>
                                <tr>
                                    <td style="width: 420px;font-weight: 600;"> ระบุชื่อ : <select class="slcCombobox"
                                            name="assigncmuitaccount" id="assigncmuitaccount"
                                    ...
                                    <td> <button class="btn btn-light btnAddAdmin"> <i
                                                class="bi bi-plus-circle-fill h4"></i> เพิ่ม</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                            ...
                            @if (count($ListAdmin) > 0)
                                @foreach ($ListAdmin as $rows)
                                    <tr style="text-align: left;">
                                        ...
                                        <td> <a href="#" id="{{$rows->id}}" class="text-danger mx-1 deleteIcon"><i
                                                    class="bi-trash h5"></i></a></td>
                                    </tr>
                                @endforeach
                            @endif
                        </tbody>
