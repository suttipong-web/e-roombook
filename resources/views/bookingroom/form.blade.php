                                ...
                                <div class="card-body justify-content-start text-start ">
                                    @if ($usertype == 'general')
                                        <div class="text-danger text-center">
                                            <h5 class="text-danger"> *** หมายเหตุ : สำหรับการจองห้อง  {{ $RoomtitleSearch }} 
                                                กรุณาติดต่อหจ้าหน้าที่ 
                                            </h5>
                                            <br/>
                                             ห้องประชุม (งานบริหารทั่วไป ) โทรศัพท์ 0-539-44171  <br/>
                                             ห้องเรียนและห้องคอมพิวเจตอร์ (งานพัฒนาเทคโนโลยี ฯ) โทรศัพท์ 0-539-44120
                                        </div>
                                    @else
